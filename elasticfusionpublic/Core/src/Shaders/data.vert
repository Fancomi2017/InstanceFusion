...
uniform usampler2D instgtSampler;
...
uniform bool hasInstanceGroundTruth;
...
void main()
{
	...
	{
		uint value = uint(texture(instgtSampler, texcoord.xy));
		//int vinstColor = int(textureLod(instgtSampler, texcoord.xy, 0.0));
		//vinstColor = (vinstColor << 8) + int(textureLod(instgtSampler, texcoord.xy, 0.0));
		//vinstColor = (vinstColor << 8) + int(textureLod(instgtSampler, texcoord.xy, 0.0));
		//vImgCorr.w = float(vinstColor);
		vImgCorr.w = float(value);
	}

	vInstInfoA = vec4(0.0,0.0,0.0,0.0);
	vInstInfoB = vec4(0.0,0.0,0.0,0.0);
	vInstInfoC = vec4(0.0,0.0,0.0,0.0);
	vInstInfoD = vec4(0.0,0.0,0.0,0.0);
	vInstInfoE = vec4(0.0,0.0,0.0,0.0);
	vInstInfoF = vec4(0.0,0.0,0.0,0.0);
	vInstInfoG = vec4(0.0,0.0,0.0,0.0);
	vInstInfoH = vec4(0.0,0.0,0.0,0.0);
	vInstInfoI = vec4(0.0,0.0,0.0,0.0);
	vInstInfoJ = vec4(0.0,0.0,0.0,0.0);
	vInstInfoK = vec4(0.0,0.0,0.0,0.0);
	vInstInfoL = vec4(0.0,0.0,0.0,0.0);
	// pht add ==========================================
