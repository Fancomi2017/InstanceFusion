...
class GPUConfig
{
    ...
    private:
           ...
           so3StepBlocks(64)
        {
            ...
            icpStepMap["TITAN Xp"] = std::pair<int, int>(128, 176);
            rgbStepMap["TITAN Xp"] = std::pair<int, int>(128, 96);
            rgbResMap["TITAN Xp"] = std::pair<int, int>(288, 176);
            so3StepMap["TITAN Xp"] = std::pair<int, int>(112, 112);
            ...
            icpStepMap["GeForce GTX 1080"] = std::pair<int, int>(128, 160);
            rgbStepMap["GeForce GTX 1080"] = std::pair<int, int>(160, 80);
            rgbResMap["GeForce GTX 1080"] = std::pair<int, int>(512, 496);
            so3StepMap["GeForce GTX 1080"] = std::pair<int, int>(160, 80);
