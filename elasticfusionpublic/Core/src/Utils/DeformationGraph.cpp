...
void DeformationGraph::graphDownload(std::string tag)
{
	std::string filename = "ResultModel_graph_"+tag+".ply";
	
	std::cout<<"write graph as ply : "<<filename<<std::endl;
	// Open file
	std::ofstream fs;
	...
	{
		Eigen::Vector3f pos = graph.at(i)->position;
